            ...
            <CRow>
                <CCol xs="12" md="10" className="mx-auto">
                    <CCard>
                        ...
                        <CCardBody>
                            <CForm encType="multipart/form-data" id="upload-form" onSubmit={(event) => {
                                ...
                                <CFormGroup row>
                                    ...
                                    <CCol xs="12" md="9">
                                        ...
                                        >
                                            ...
                                            <option value="1 MST">MST 1</option>
                                            <option value="2 MST">MST 2</option>
                                            <option value="3 MST">MST 3</option>
